...
//   { id:  6, correctAnswer:   5612, tolerance: 0, maxAttempts: 1, points:     }, //tbp
...
//   { id: 16, correctAnswer:  228, tolerance: 0, maxAttempts: 1, points:     },
// { id: 17, correctAnswer:  271, tolerance: 4, maxAttempts: 1, points:     },
...
//   { id: 24, correctAnswer:   3527, tolerance: 0, maxAttempts: 1, points:     }, //needs answer  done
...
// ];
const sampleQuestions = [
  { id:  1, correctAnswer:    2, tolerance: 0, maxAttempts: 2, points: 1 },
  { id:  2, correctAnswer:   30, tolerance: 0, maxAttempts: 2, points: 3 },
  { id:  3, correctAnswer:  207, tolerance: 1, maxAttempts: 2, points: 2 },
  { id:  4, correctAnswer: 2340, tolerance: 0, maxAttempts: 2, points: 4 },
  { id:  5, correctAnswer:    7, tolerance: 0, maxAttempts: 2, points: 4 },
  { id:  6, correctAnswer: 5612, tolerance: 0, maxAttempts: 2, points: 2 }, //tbp
  { id:  7, correctAnswer:   11, tolerance: 0, maxAttempts: 2, points: 2 },
  { id:  8, correctAnswer: 2519, tolerance: 0, maxAttempts: 2, points: 2 },
  { id:  9, correctAnswer:  757, tolerance: 0, maxAttempts: 2, points: 1 },
  { id: 10, correctAnswer: 1284, tolerance: 0, maxAttempts: 2, points: 3 },
  { id: 11, correctAnswer:  981, tolerance: 0, maxAttempts: 1, points: 2 },
  { id: 12, correctAnswer:    1, tolerance: 0, maxAttempts: 1, points: 3 },
  { id: 13, correctAnswer:   60, tolerance: 0, maxAttempts: 1, points: 2 },
  { id: 14, correctAnswer:  565, tolerance: 0, maxAttempts: 1, points: 4 },
  { id: 15, correctAnswer: 1233, tolerance: 0, maxAttempts: 1, points: 2 },
  { id: 16, correctAnswer:  228, tolerance: 0, maxAttempts: 1, points: 2 },
  { id: 17, correctAnswer:  271, tolerance: 4, maxAttempts: 1, points: 4 },
  { id: 18, correctAnswer: 4130 , tolerance: 0, maxAttempts: 1, points: 5 }, //needs modification - modified
  { id: 19, correctAnswer:   10, tolerance: 0, maxAttempts: 1, points: 3 },
  { id: 20, correctAnswer: 3591, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 21, correctAnswer:   14, tolerance: 0, maxAttempts: 1, points: 3 },
  { id: 22, correctAnswer:    2, tolerance: 0, maxAttempts: 1, points: 4 },
  { id: 23, correctAnswer:  737, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 24, correctAnswer: 3527, tolerance: 0, maxAttempts: 1, points: 5 }, //needs answer  done
  { id: 25, correctAnswer:   54, tolerance: 0, maxAttempts: 1, points: 4 },
  { id: 26, correctAnswer:    3, tolerance: 0, maxAttempts: 1, points: 3 },
  { id: 27, correctAnswer:    2, tolerance: 0, maxAttempts: 1, points: 6 },
  { id: 28, correctAnswer:    0, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 29, correctAnswer: 1000, tolerance: 0, maxAttempts: 1, points: 9 },
  { id: 30, correctAnswer:   92, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 31, correctAnswer:  817, tolerance: 0, maxAttempts: 1, points: 6 },
  { id: 32, correctAnswer:   17, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 33, correctAnswer:    9, tolerance: 0, maxAttempts: 1, points: 6 }, //may change
  { id: 34, correctAnswer: 8865, tolerance: 0, maxAttempts: 1, points: 8 }, // Points updated
  { id: 35, correctAnswer:   61, tolerance: 0, maxAttempts: 1, points: 5 },
  { id: 36, correctAnswer:   30, tolerance: 0, maxAttempts: 1, points: 7 }, //needs modification modified ans
  { id: 37, correctAnswer:   13, tolerance: 0, maxAttempts: 1, points: 6 },
  { id: 38, correctAnswer:  130, tolerance: 0, maxAttempts: 1, points: 10 }, // Points updated
  { id: 39, correctAnswer:   10, tolerance: 0, maxAttempts: 1, points: 6 },
  { id: 40, correctAnswer:  375, tolerance: 0, maxAttempts: 1, points: 10 }, // Points updated
  { id: 41, correctAnswer:   10, tolerance: 7, maxAttempts: 1, points: 10 }, // Points updated //check once ans 4-17
  { id: 42, correctAnswer:   15, tolerance: 0, maxAttempts: 1, points: 9 }, // Points updated
  { id: 43, correctAnswer:   60, tolerance: 0, maxAttempts: 1, points: 7 },
];
